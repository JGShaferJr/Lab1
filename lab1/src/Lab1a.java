...
public class Lab1a {
    ...
    /* Method reads in integers from a file, counts the amount of 
     * integers, determines the max, and displays the contents on the screen. */
    public void readFile() {
	try {
	    File inputFile = new File("src/Lab1a.dat");
	    Scanner input = new Scanner(inputFile);
	    intVector = new Vector<Integer>();
	    int max=-99, elt,count=0; //initialized max very low
